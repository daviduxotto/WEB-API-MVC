...
namespace Datos
{
   public class dMovimientoPagoCC : conexionBD
   {
      public DataTable getMovPagoCCXFecha(eMovimientoPagoCC movimiento)
      {
         ...
         if (abrirBD())
         {
            try
            {
               MySqlDataAdapter adaptador = new MySqlDataAdapter("get_detmovbcopagoclientefectivxesxfch", Conexion);
      ...
      public DataTable getMovPagoCCXFechaDetalle(eMovimientoPagoCC movimiento)
      {
         DataTable tblResultado = new DataTable();
         if (abrirBD())
         {
            try
            {
               MySqlDataAdapter adaptador = new MySqlDataAdapter("get_detmovbcopagoclientefectivxesxfch_det", Conexion);
               adaptador.SelectCommand.CommandType = CommandType.StoredProcedure;
               MySqlParameter prmEmpresa = adaptador.SelectCommand.Parameters.Add("parempresa", MySqlDbType.VarChar, 5);
               prmEmpresa.Value = dLibreria.left(movimiento.codEmpresa, 5);
               MySqlParameter prmSucursal = adaptador.SelectCommand.Parameters.Add("parsucursal", MySqlDbType.VarChar, 4);
      ...
      public eParSalida conciliar(eMovimientoPagoCC MovimientoEfectivo)
      {
      ...
      public DataTable getLiquidacionPagoClienteXempresa(eMovimientoPagoCC movimiento)
      {
         DataTable tblResultado = new DataTable();
         if (abrirBD())
         {
      ...
      public eParSalida cambioCodigo(eMovimientoPagoCC MovimientoPagoCC)
      {
         eParSalida parSalida = new eParSalida();
         if (abrirBD())
         {
      ...
      public DataTable infoMovClienteXFecha(eMovimientoPagoCC movimiento)
      {
         DataTable tblResultado = new DataTable();
         if (abrirBD())
         {
            try
            {
               MySqlDataAdapter adaptador = new MySqlDataAdapter("info_deptoclienteconcixes", Conexion);
               adaptador.SelectCommand.CommandType = CommandType.StoredProcedure;
               MySqlParameter prmEmpresa = adaptador.SelectCommand.Parameters.Add("parempresa", MySqlDbType.VarChar, 5);
               prmEmpresa.Value = dLibreria.left(movimiento.codEmpresa, 5);
               MySqlParameter prmSucursal = adaptador.SelectCommand.Parameters.Add("parsucursal", MySqlDbType.VarChar, 4);
      ...
      public DataTable infoClienteefectivoVsConciliado(eMovimientoPagoCC movimiento)
      {
         DataTable tblResultado = new DataTable();
         if (abrirBD())
         {
            try
            {
               MySqlDataAdapter adaptador = new MySqlDataAdapter("info_clienteefecvsconci", Conexion);
               adaptador.SelectCommand.CommandType = CommandType.StoredProcedure;
               MySqlParameter prmEmpresa = adaptador.SelectCommand.Parameters.Add("parempresa", MySqlDbType.VarChar, 5);
               prmEmpresa.Value = dLibreria.left(movimiento.codEmpresa, 5);
               MySqlParameter prmSucursal = adaptador.SelectCommand.Parameters.Add("parsucursal", MySqlDbType.VarChar, 4);
      ...
      public DataTable infoClienteefectivoVsConciliadoGrafico(eMovimientoPagoCC movimiento)
      {
         DataTable tblResultado = new DataTable();
         if (abrirBD())
         {
            try
            {
               MySqlDataAdapter adaptador = new MySqlDataAdapter("info_clienteefecvsconci_grafico", Conexion);
               adaptador.SelectCommand.CommandType = CommandType.StoredProcedure;
               MySqlParameter prmEmpresa = adaptador.SelectCommand.Parameters.Add("parempresa", MySqlDbType.VarChar, 5);
               prmEmpresa.Value = dLibreria.left(movimiento.codEmpresa, 5);
               MySqlParameter prmSucursal = adaptador.SelectCommand.Parameters.Add("parsucursal", MySqlDbType.VarChar, 4);
      ...
      public eParSalida getEstadoPantalla(eMovimientoPagoCC Movimiento)
      {
         eParSalida parSalida = new eParSalida();
         if (abrirBD())
         {
      ...
      public eParSalida abrirPantallaUV(eMovimientoPagoCC Movimiento)
      {
         eParSalida parSalida = new eParSalida();
         if (abrirBD())
         {
      ...
      public eParSalida cerrarPantallaUV(eMovimientoPagoCC Movimiento)
      {
         eParSalida parSalida = new eParSalida();
         if (abrirBD())
         {
            MySqlCommand comando = new MySqlCommand("proc_cerrar_pantalla_pagoclienteefec_uv", Conexion);
            comando.CommandType = CommandType.StoredProcedure;
            //parametros de entrada
            // casting de parametros conforme al procedimentno almacenado
